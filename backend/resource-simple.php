...
if ($response === 'y') {
    ...
    do {
        echo "\n\033[33mMasukkan nomor model yang ingin dikecualikan (Pisahkan nomor menggunakan ',')  : \033[0m";
...
foreach ($modelsToProcess as $model) {
    $command = "php artisan make:filament-resource $model --generate --view --simple";
