...
export default function BillingFinishedPage() {
    ...
    const itemTrxId = queryParams.get("trx_id");
    ...
    return (
        <main className="relative mx-auto flex min-h-screen max-w-[640px] flex-col gap-5 bg-[#F6F6F8] pb-[48px]">
            <div id="Background" className="absolute left-0 right-0 top-0">
                <img
                    src="/assets/images/backgrounds/black.png"
                    alt="image"
                    ...
                    <div id="ProgressBar" className="relative px-[12px]">
                        <div className="flex">
                            ...
                            <div className="relative flex h-[25px] w-full items-center">
                                ...
                                <div className="right-0 h-2 w-1/2 rounded-full bg-items-purple" />
                            </div>
            ...
            <header className="relative flex flex-col gap-4 px-5">
                ...
                <div className="flex flex-col gap-[4px]">
                    ...
                    <p className="text-white">
                        Gunakan informasi di bawah agar anda dapat melihat status Pesanan anda.
                    </p>
                </div>
            </header>
            <section id="Information" className="relative px-5">
                <div className="flex w-full flex-col gap-5 rounded-3xl bg-white px-[14px] py-5">
                    <label className="flex flex-col gap-[6px]">
                        <h4 className="font-semibold text-[#030504]">ID Transaksi</h4>
                        <div>
                            <div className="relative flex h-[54px] items-center justify-center rounded-full bg-[#E0E0EC]">
                                <input
                                    defaultValue={itemTrxId ? itemTrxId : 'Tidak Diketahui'}
                                    readOnly
                                    type="text"
                                    name=""
                                    id=""
                    ...
                    <label className="flex flex-col gap-[6px]">
                        ...
                        <div>
                            <div className="relative flex h-[54px] items-center justify-center rounded-full bg-[#E0E0EC]">
                                <input
                                    defaultValue={email ? email : 'Tidak Diketahui'}
                                    readOnly
                                    type="text"
                                    name=""
                                    id=""
            ...
            >
                <Link
                    to={'/'}
                    className="flex w-full justify-center rounded-full bg-items-gradient-pink-white py-[14px] font-semibold text-white transition-all duration-300 hover:shadow-[0px_6px_22px_0px_#FF4D9E82]"
                >
                    Belanja Lagi
                </Link>
                <Link
